...
const Header = () => { 
    ...
    return (
        <div className='absolute z-10 flex w-full items-center justify-between px-6 bg-gradient-to-b from-black'>
            <img className='w-56 pt-[10px] bg-gradient-to-b from-black' src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Netflix_2015_logo.svg/1198px-Netflix_2015_logo.svg.png" alt="netflix-logo" />
            {
                user && (
                    <div className='flex items-center'>
                        ...
                        <div className='ml-4'>
                            <Link to="/wishList"><button className='bg-red-800 text-white mr-3 py-2 px-[4px]'>WishList</button></Link>
